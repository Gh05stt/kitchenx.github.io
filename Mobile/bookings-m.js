...
function populatePendingListings(listId) {
    ...
    for (let i = 0; i < numProperties; i++) {
        ...
        <div class="property-details">
            ...
            <div class="manage-property">
                <li>
                <div class="approve-btn"><a href="#" data-action="approve"><i class="fa-solid fa-check"></i></a></div>
            </li>
            <li>
                <div class="message-btn"><a href="404-m.html"><i class="fa-solid fa-message"></i></a></div>
            </li>
            <li>
                <div class="deny-btn"><a href="#" data-action="deny"><i class="fa-solid fa-xmark"></i></a></div>
            </li>
